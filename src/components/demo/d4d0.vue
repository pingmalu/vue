<template>
  <div>
    ...
    <!-- <div style="display:none">
      <img :src="apng" alt="a.png">
      <img :src="bpng" alt="b.png">
    </div> -->
    <div id="d1d2"></div>
...
import BAS from "../../assets/js/bas.js";
import "gsap";
...
SlideGeometry.prototype = Object.create(BAS.ModelBufferGeometry.prototype);
...
SlideGeometry.prototype.bufferPositions = function() {
  ...
  for (var i = 0; i < this.faceCount; i++) {
    ...
    var centroid = BAS.Utils.computeCentroid(this.modelGeometry, face);
...
export default {
  ...
  data() {
    return {
      msg: null,
      apng: require("../../assets/image/a.png"),
      bpng: require("../../assets/image/b.png")
    };
  },
  mounted() {
    init({a:this.apng,b:this.bpng});
  }
};
</script>
